...
const (
	...
	ObjectLock              FlagName = "object-lock"
...
func init() {
	Flag.SetFlags(map[FlagName]FlagDesc{
		...
		ObjectLock:              {Type: Alpha, Description: "enable experimental S3 Object Lock support for 'restic protect' and '--skip-object-locked' in 'forget'/'prune'"},
